...
#define isPinAnalog(pin) ((20>pin)&(pin>13))
#define digitalPinToAnalogNum(pin) (pin-14) //defined channel array must
...
#define PIN_16_BIT			1
#define PIN_17_BIT			0
#define PIN_18_BIT			16
#define PIN_19_BIT			30
#define PIN_20_BIT			18 //also xtal on bottom and not usable if populated
#define PIN_21_BIT			19 //also xtal on bottom and not usable if populated
...
#define PIN_0_PORT			PrtA
#define PIN_1_PORT			PrtA
#define PIN_2_PORT			PrtA
#define PIN_3_PORT			PrtA
#define PIN_4_PORT			PrtE
#define PIN_5_PORT			PrtC
#define PIN_6_PORT			PrtC
#define PIN_7_PORT			PrtC
#define PIN_8_PORT			PrtC
#define PIN_9_PORT			PrtC
#define PIN_10_PORT			PrtD
#define PIN_11_PORT			PrtD
#define PIN_12_PORT			PrtD
#define PIN_13_PORT			PrtD
#define PIN_14_PORT			PrtC
#define PIN_15_PORT			PrtC
#define PIN_16_PORT			PrtB
#define PIN_17_PORT			PrtB
#define PIN_18_PORT			PrtE
#define PIN_19_PORT			PrtE
#define PIN_20_PORT			PrtA
#define PIN_21_PORT			PrtA

#define PIN_0_CONFIG		PORTA_BASE
#define PIN_1_CONFIG		PORTA_BASE
#define PIN_2_CONFIG		PORTA_BASE
#define PIN_3_CONFIG		PORTA_BASE
#define PIN_4_CONFIG		PORTE_BASE
#define PIN_5_CONFIG		PORTC_BASE
#define PIN_6_CONFIG		PORTC_BASE
#define PIN_7_CONFIG		PORTC_BASE
#define PIN_8_CONFIG		PORTC_BASE
#define PIN_9_CONFIG		PORTC_BASE
#define PIN_10_CONFIG		PORTD_BASE
#define PIN_11_CONFIG		PORTD_BASE
#define PIN_12_CONFIG		PORTD_BASE
#define PIN_13_CONFIG		PORTD_BASE
#define PIN_14_CONFIG		PORTC_BASE
#define PIN_15_CONFIG		PORTC_BASE
#define PIN_16_CONFIG		PORTB_BASE
#define PIN_17_CONFIG		PORTB_BASE
#define PIN_18_CONFIG		PORTE_BASE
#define PIN_19_CONFIG		PORTE_BASE
#define PIN_20_CONFIG		PORTA_BASE
#define PIN_21_CONFIG		PORTA_BASE
